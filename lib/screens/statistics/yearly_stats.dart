...
class _YearlyStatsState extends State<YearlyStats> {
  ...
  //     (index) => _buildBar(index, widget.groupedTransactionValues[index]['amount'], isTouched: index == touchedIndex),
  //   );
  // }
  ...
  //         switch (value.toInt()) {
  //           case 0:
  //             return widget.groupedTransactionValues[0]['month'].toString().substring(0, 3);
  //           case 1:
  //             return widget.groupedTransactionValues[1]['month'].toString().substring(0, 3);
  //           case 2:
  //             return widget.groupedTransactionValues[2]['month'].toString().substring(0, 3);
  //           case 3:
  //             return widget.groupedTransactionValues[3]['month'].toString().substring(0, 3);
  //           case 4:
  //             return widget.groupedTransactionValues[4]['month'].toString().substring(0, 3);
  //           case 5:
  //             return widget.groupedTransactionValues[5]['month'].toString().substring(0, 3);
  //           default:
  //             return '';
  //         }
  //       },
